...
**Elevated**:
Whether the run holds Administrator rights. Only power settings require them; a
non-elevated run still completes, reporting the power Steps as needing elevation
