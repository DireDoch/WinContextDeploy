...
$T = if ($ScriptUI -eq 'EN') {
    @{
        ...
        Remedy                  = @{
            ...
            LocalAdminPosture   = 'Point at the baseline that owns this and let it decide. Confirm another account can elevate before disabling the built-in Administrator.'
            LocalAdminUnreadable = 'The local accounts could not be read. Check the built-in Administrator by hand in lusrmgr.msc before handover.'
    ...
    @{
        ...
        Remedy                  = @{
            ...
            LocalAdminPosture   = 'Renvoyer a la reference de securite qui en est responsable et la laisser trancher. Confirmer qu un autre compte peut elever avant de desactiver l Administrateur integre.'
            LocalAdminUnreadable = 'Les comptes locaux n ont pas pu etre lus. Verifier l Administrateur integre a la main dans lusrmgr.msc avant la remise.'
